...
import { Block, Text, theme, Button as GaButton, Toast } from 'galio-framework';
...
const thumbMeasure = (width - 40 - 32) / 3;
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <Block flex style={{ marginTop: 20 }}>
            <Block middle>
              ...
              >
                A full-stack developer seeking for opportunities to work and grow in an organization
                and to enhance my skills to help in the overall success of the organization as well.
              </Text>
            </Block>
